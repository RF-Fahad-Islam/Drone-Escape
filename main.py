...
flap_sound = pg.mixer.Sound(os.path.join(SFX, "flap.wav"))
point_sound = pg.mixer.Sound(os.path.join(SFX, "score.wav"))
powerup_sound = pg.mixer.Sound(os.path.join(SFX, "powerup.wav"))
dash_sound = pg.mixer.Sound(os.path.join(SFX, "dash.ogg"))
bgm = pg.mixer.Sound(os.path.join(SFX, "bgm.mp3"))
hit_sound = pg.mixer.Sound(os.path.join(SFX, "dead.wav"))
