...
**Drone Escape** is a side-scrolling survival game where you control a drone navigating through gaps, avoiding obstacles, and collecting power-ups.The world scrolls continuously, pipes spawn at random heights, and the game becomes harder the longer you survive.
...
KeyAction**SPACE**Flap / Jump**SPACE (on Game Over)**Restart
...
Developed by **Fahad Islam**Sprites, SFX, and game logic made manually for this project.